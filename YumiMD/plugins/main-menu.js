...
conn.sendPresenceUpdate("composing", m.chat)
  ...
  let arrayMenu = ['anonymous', 'main', 'ai', 'jadibot',  'textprome', 'bug', 'store', 'ephoto', 'downloader', 'convert', 'premium', 'game', 'group', 'internet', 'maker', 'owner', 'rpg', 'sticker', 'tools', 'anime', 'fun']
...
≡ *Prefix* : [ . ]\n\n`    
      ...
      capt += `brings up all commands  *.menuall*`
